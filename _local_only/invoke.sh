...
if [ "$DIRECTORY" = "subscription-bootstrap" ]; then
  ...
  TF_VAR_gateway_address_space=$(echo $TF_VAR_gateway_address_space | sed 's/\"/\\\"/g')
  TF_VAR_vnet_address_space=$(echo $TF_VAR_vnet_address_space | sed 's/\"/\\\"/g')
  TF_VAR_private_subnet_address_prefixes=$(echo $TF_VAR_private_subnet_address_prefixes | sed 's/\"/\\\"/g')
  TF_VAR_gateway_address_prefixes=$(echo $TF_VAR_gateway_address_prefixes | sed 's/\"/\\\"/g')
